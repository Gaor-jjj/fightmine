...
export async function updateUserAchievements(userId, achievementId) {
    try {
        ...
        console.log('Current achievements:', user.achievements); // Log current achievements
        ...
        if (user.achievements && user.achievements.includes(achievementId)) {
            console.log(`Achievement ${achievementId} is already in the list, skipping update.`);
        ...
        console.log(`Achievement ${achievementId} successfully updated.`);
    } catch (error) {
